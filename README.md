...
The site is a common space that presents a diary as a collaborative canvas: people will create
...
The concept takes shapes(/is communicated) with a strong visual identity, which is inspired by hand–drawn sketches in order to express the "diary mood".  

### Inspirations

The design of this site was inspired by some works on behance:

### Visual identity

 Here some important aspects of the visual identity:

**Logo** <br>
The logo is composed by two aspects: the title of the site (Spit It Out) and a stylized megaphone, that
represents the voice (a key element of the experience). Another characteristic is the applied texture, which gives an hand drawn look.
<p align="center">
...
The color palette is very simple, composed by only two main colours (black and white) which resembles **ink**
and **paper**. The two textures too are selected to remember paper and ink.
...
**Animations** <br>
Last but not the least, there's the large use of animations. They have been included as hovers (so they can be triggered by passing the mouse on it) or as simple visual effects (such as the titles of the sections). All these animations follow the previous rules of the visual identity.
...
The UX have been designed to be simple and easily understood. The site presents two main sections: one is "Home page" (reachable in any moment by pressing on the button with site's logo settled in the top-left of the page), in which you can find a welcome message, informations about the site and the credits. The other one, called "Diary" (reachable by pressing the diary in the top-right part of the site or the button "write in the diary" in the Home page), is the common space where you can find the messages left by other users around the world.

<p align="center">
  <img src="assets/readme/UX.png" width="900">
</p>

Users can add their own messages by pressing the button "Write in the diary" settled in the section Diary. If clicked, a window will appear and step by step it will be explained how to insert a message:
